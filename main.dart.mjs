...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      IJ: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      ...
      ZG: x0 => x0.y,
      ZH: x0 => x0.index,
      ZI: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      ZJ: x0 => x0.getReader(),
      ...
      bG: x0 => x0.offsetTop,
      bH: x0 => x0.value,
      bI: (x0,x1,x2) => x0.addEventListener(x1,x2),
      bJ: x0 => x0.done,
      c: o => o,
      ...
      eJ: (x0,x1) => new OffscreenCanvas(x0,x1),
